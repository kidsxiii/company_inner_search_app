...
SUPPORTED_EXTENSIONS = {
    ...
    ".txt": lambda path: TextLoader(path, encoding="utf-8") #(問題5用)
}
...
# RAG設定用パラメータ
# ==========================================
TOP_K = 5  # ベクターストアから取得する関連チャンクの数
CHUNK_SIZE = 500  # チャンク分割時の最大文字数
CHUNK_OVERLAP = 50  # チャンクの重なり文字数
...
# ヘルパーテキストなどの表示文言
# ==========================================
INITIAL_AI_MESSAGE = "こんにちは。私は社内文書の情報をもとに回答する生成AIチャットボットです。サイドバーで利用目的を選択し、画面下部のチャット欄からメッセージを送信してください。"
INPUT_GUIDE_MESSAGE = "具体的に入力したほうが期待通りの回答を得やすいです。"
